...
from content_owner.persistence.schema import mapper_registry
...
def app() -> FastAPI:
    ...
    from content_owner.api import create_app
    from content_owner.api import app as api_app
    ...
    HttpxAuthService.create_content_owner_user = fake_create_user  # type: ignore[method-assign]
