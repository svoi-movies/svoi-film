...
from company.domain.company import Company, CompanyStatus
from company.domain.content_owner import ContentOwner, ContentOwnerStatus
...
def wire_mappers() -> None:
    mapper_registry.map_imperatively(
        ...
        properties={
            "_id": companies.c.id,
            "_name": companies.c.name,
            "_status": companies.c.status,
            "_created_at": companies.c.created_at,
            "_updated_at": companies.c.updated_at,
        },
    )
