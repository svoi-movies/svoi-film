...
from payments.container import create_container
from payments.persistence.schema import wire_mappers
...
async def declare_exchanges(container: AsyncContainer) -> None:
    ...
    async with connection.channel() as channel:
        ...
        all_payments = await channel.declare_queue("payments.all", durable=True)
        await all_payments.bind(payments_exchange, routing_key="#")
