...
from payments.domain.user import User
from payments.domain.value_objects import Email, UserPassword
from payments.services.password_hasher import BcryptPasswordHasher
